...
export const checkValid = {
    ...
    methods: {
            ...
            switch (this.$props.mode) {
                case 'contracts':
                    ...
                    if (form.name.$invalid) {
                        ...
                        this.isValidForm = false
                        s = 'Сумма договора должна быть числом, не меньше нуля.'
                    } else if (form.$error) {
                        this.isValidForm = false
                ...
                case 'stages':
                    ...
                    if (form.name.$invalid) {
                        ...
                        this.isValidForm = false
                        s = 'Плановые расходы этапа на зарплату должны быть числом, не меньше нуля.'
                    } else if (form.approxCredit.$invalid) {
                        this.isValidForm = false
                        s = 'Плановые расходы этапа на материалы должны быть числом, не меньше нуля.'
                    }else if(form.credit.$invalid){
                        this.isValidForm = false
                        s = 'Фактические расходы этапа на материалы должны быть числом, не меньше нуля.'
                    } else if(form.salary.$invalid){
                        this.isValidForm = false
                        s = 'Фактические расходы этапа на зарплату должны быть числом, не меньше нуля.'
                    } else if (form.$error){
                        this.isValidForm = false
                        s = 'Пожалуйста, введите все поля.'
                    } else this.isValidForm = true
                ...
                case 'contractsCounterparty':
                    ...
                    if (form.name.$invalid) {
                        ...
                        this.isValidForm = false
                        s = 'Сумма договора с контрагентом должна быть числом, не меньше нуля.'
                        this.isValidForm = false
                    } else if(!(this.isValidApproxBeginDate && this.isValidApproxEndDate && this.isValidBeginDate && this.isValidEndDate)){
        ...
        checkPropInsideContractDates(s){
            if(!(this.isApproxInsideContractDates)){
                ...
                this.isValidForm = false
            } else if(!(this.isInsideContractDates)){
